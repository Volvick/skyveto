<?php
// File: pending_payments.php (NEW)
// Location: /admin/
include_once 'common/header.php';

$search_id = $_GET['search_id'] ?? '';

// Base query for pending payment orders
$sql = "
...
<h1 class="text-2xl font-bold mb-6">Pending Payment Orders</h1>

<div class="mb-4">
    <form method="GET" action="pending_payments.php" class="flex items-center">
        ...
        <?php if (!empty($search_id)): ?>
            <a href="pending_payments.php" class="ml-4 text-sm text-gray-600 hover:text-gray-800 underline">Clear Search</a>
        <?php endif; ?>
    </form>
</div>
...
<div class="bg-white p-6 rounded-xl shadow-lg">
    <div class="overflow-x-auto">
        <table class="w-full">
            ...
            <tbody>
                <?php if (empty($orders)): ?>
                    <tr><td colspan="6" class="p-4 text-center text-gray-500">No pending payment orders found.</td></tr>
                <?php else: ?>
