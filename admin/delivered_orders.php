...
<h1 class="text-2xl font-bold mb-6">Delivered Orders</h1>

<div class="mb-4">
    <form method="GET" action="delivered_orders.php" class="flex items-center">
        ...
        <?php if (!empty($search_id)): ?>
            <a href="delivered_orders.php" class="ml-4 text-sm text-gray-600 hover:text-gray-800 underline">Clear Search</a>
        <?php endif; ?>
    </form>
</div>
...
<div class="bg-white p-6 rounded-xl shadow-lg">
    <div class="overflow-x-auto">
        <table class="w-full">
            ...
            <tbody>
                <?php if (empty($orders)): ?>
                    <tr><td colspan="6" class="p-4 text-center text-gray-500">No delivered orders found.</td></tr>
                <?php else: ?>
